...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("org-elpa" ("2022-04-14 16:06:03" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2022-04-14 16:06:03" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2022-04-14 16:06:03" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "el-get" ("2022-04-14 16:06:03" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2022-04-14 16:06:03" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "straight" ("2022-04-14 16:06:03" ("emacs") (:type git :host github :repo "raxod502/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "use-package" ("2022-04-14 16:06:03" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2022-04-14 16:06:03" nil (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github)) "auto-package-update" ("2022-04-14 16:06:03" ("emacs" "dash") (:type git :flavor melpa :host github :repo "rranelli/auto-package-update.el" :package "auto-package-update" :local-repo "auto-package-update.el")) "dash" ("2022-04-14 16:06:03" ("emacs") (:type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el" :package "dash" :local-repo "dash.el")) "which-key" ("2022-04-14 16:06:03" ("emacs") (:type git :flavor melpa :host github :repo "justbur/emacs-which-key" :package "which-key" :local-repo "emacs-which-key")) "yasnippet" ("2022-04-14 16:06:03" ("cl-lib") (:type git :flavor melpa :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet" :package "yasnippet" :local-repo "yasnippet")) "ace-window" ("2022-04-14 16:06:03" ("avy") (:type git :flavor melpa :host github :repo "abo-abo/ace-window" :package "ace-window" :local-repo "ace-window")) "avy" ("2022-04-14 16:06:03" ("emacs" "cl-lib") (:type git :flavor melpa :host github :repo "abo-abo/avy" :package "avy" :local-repo "avy")) "dashboard" ("2022-04-14 16:06:03" ("emacs") (:type git :flavor melpa :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/emacs-dashboard" :package "dashboard" :local-repo "emacs-dashboard")) "doom-themes" ("2022-04-14 16:06:03" ("emacs" "cl-lib") (:type git :flavor melpa :files (:defaults "themes/*.el" "themes/*/*.el" "extensions/*.el" "doom-themes-pkg.el") :host github :repo "doomemacs/themes" :package "doom-themes" :local-repo "themes")) "rainbow-delimiters" ("2022-04-14 16:06:03" nil (:type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters" :package "rainbow-delimiters" :local-repo "rainbow-delimiters")) "rainbow-mode" ("2022-04-14 16:06:03" nil (:type git :host github :repo "emacs-straight/rainbow-mode" :files ("*" (:exclude ".git")) :package "rainbow-mode" :local-repo "rainbow-mode")) "bespoke-modeline" ("2022-04-14 16:06:03" ("emacs") (:type git :host github :repo "mclear-tools/bespoke-modeline" :package "bespoke-modeline" :local-repo "bespoke-modeline")) "ivy" ("2022-04-14 16:06:03" ("emacs") (:type git :flavor melpa :files (:defaults (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "doc/ivy-help.org" "ivy-pkg.el") :host github :repo "abo-abo/swiper" :package "ivy" :local-repo "swiper")) "ivy-rich" ("2022-04-14 16:06:03" ("emacs" "ivy") (:type git :flavor melpa :files ("*.el" "ivy-rich-pkg.el") :host github :repo "Yevgnen/ivy-rich" :package "ivy-rich" :local-repo "ivy-rich")) "counsel" ("2022-04-14 16:06:03" ("emacs" "ivy" "swiper") (:flavor melpa :files ("counsel.el" "counsel-pkg.el") :package "counsel" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "swiper" ("2022-04-14 16:06:03" ("emacs" "ivy") (:flavor melpa :files ("swiper.el" "swiper-pkg.el") :package "swiper" :local-repo "swiper" :type git :repo "abo-abo/swiper" :host github)) "ox-jekyll-md" ("2022-04-14 16:06:03" nil (:type git :flavor melpa :host github :repo "gonsie/ox-jekyll-md" :package "ox-jekyll-md" :local-repo "ox-jekyll-md")) "org-bullets" ("2022-04-14 16:06:03" nil (:type git :flavor melpa :host github :repo "integral-dw/org-bullets" :package "org-bullets" :local-repo "org-bullets")) "all-the-icons" ("2022-04-14 16:06:03" ("emacs") (:type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el" :package "all-the-icons" :local-repo "all-the-icons.el")) "octicons" ("2022-04-10 02:38:57" ("cl-lib") (:type git :flavor melpa :host github :repo "emacsorphanage/octicons" :package "octicons" :local-repo "octicons")) "page-break-lines" ("2022-04-14 16:06:03" ("emacs") (:type git :flavor melpa :host github :repo "purcell/page-break-lines" :package "page-break-lines" :local-repo "page-break-lines"))))
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bind-key" '("bind-key" "compare-keybindings" "get-binding-description" "override-global-m" "personal-keybindings"))) (provide 'bind-key-autoloads)) "use-package" ((use-package-autoloads use-package-ensure use-package-lint use-package-delight use-package-jump use-package-diminish use-package use-package-core use-package-bind-key) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Loads PACKAGE and then binds the key sequence used to invoke
...
with the specified `:load-path' the module cannot be found." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "use-package-lint" '("use-package-lint-declaration"))) (provide 'use-package-autoloads)) "dash" ((dash dash-autoloads) (autoload 'dash-fontify-mode "dash" "Toggle fontification of Dash special variables.
...
(fn &optional ASYNC)" t nil) (autoload 'auto-package-update-now-async "auto-package-update" "Update installed Emacs packages with an async manner.
If FORCE is non-nil, kill the update thread anyway.

(fn &optional FORCE)" t nil) (autoload 'auto-package-update-at-time "auto-package-update" "Try to update every day at the specified TIME.

(fn TIME)" nil nil) (autoload 'auto-package-update-maybe "auto-package-update" "Update installed Emacs packages if at least
`auto-package-update-interval' days have passed since the last
update." nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "auto-package-update" '("apu--" "auto-package-"))) (provide 'auto-package-update-autoloads)) "which-key" ((which-key-autoloads which-key) (defvar which-key-mode nil "Non-nil if Which-Key mode is enabled.
...
KEYMAP is selected interactively by mode in
`minor-mode-map-alist'." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "which-key" '("evil-state" "which-key-"))) (provide 'which-key-autoloads)) "yasnippet" ((yasnippet-autoloads yasnippet) (autoload 'yas-minor-mode "yasnippet" "Toggle YASnippet mode.
...
(fn &optional ARG)" t nil) (autoload 'snippet-mode "yasnippet" "A mode for editing yasnippets" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "yasnippet" '("help-snippet-def" "snippet-mode-map" "yas"))) (provide 'yasnippet-autoloads)) "avy" ((avy avy-autoloads) (autoload 'avy-process "avy" "Select one of CANDIDATES using `avy-read'.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "rainbow-mode" '("rainbow-"))) (provide 'rainbow-mode-autoloads)) "bespoke-modeline" ((bespoke-modeline-autoloads bespoke-modeline) (autoload 'bespoke-modeline-visual-bell-fn "bespoke-modeline" "Blink the mode-line red briefly. Set `ring-bell-function' to this to use it." nil nil) (autoload 'bespoke-modeline-visual-bell-config "bespoke-modeline" "Enable flashing the mode-line on error." nil nil) (defvar bespoke-modeline-mode nil "Non-nil if Bespoke-Modeline mode is enabled.
See the `bespoke-modeline-mode' command
for a description of this minor mode.
Setting this variable directly does not take effect;
either customize it (see the info node `Easy Customization')
or call the function `bespoke-modeline-mode'.") (custom-autoload 'bespoke-modeline-mode "bespoke-modeline" nil) (autoload 'bespoke-modeline-mode "bespoke-modeline" "Toggle bespoke-modeline minor mode
...
(fn &optional ARG)" t nil) (autoload 'bespoke-modeline-reload-current-theme "bespoke-modeline" "Reloads the currently activated theme." nil nil) (autoload 'bespoke-modeline-enable-theme "bespoke-modeline" "Enables the specified color-theme.
Pass `*default*' to select Emacs defaults.

(fn THEME)" nil nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bespoke-modeline" '("bespoke-"))) (provide 'bespoke-modeline-autoloads)) "ivy" ((ivy-autoloads ivy colir elpa ivy-faces ivy-overlay) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "colir" '("colir-"))) (autoload 'ivy-resume "ivy" "Resume the last completion session, or SESSION if non-nil.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ivy-rich" '("ivy-rich-"))) (provide 'ivy-rich-autoloads)) "swiper" ((swiper swiper-autoloads) (autoload 'swiper-avy "swiper" "Jump to one of the current swiper candidates with `avy'." t nil) (autoload 'swiper-backward "swiper" "`isearch-backward' with an overview.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "counsel" '("counsel-" "ivy-function-called-at-point" "tmm-km-list"))) (provide 'counsel-autoloads)) "ox-jekyll-md" ((ox-jekyll-md-autoloads ox-jekyll-md) (autoload 'org-jekyll-md-export-as-md "ox-jekyll-md" "Export current buffer as a Markdown buffer adding some YAML front matter.

(fn &optional ASYNC SUBTREEP VISIBLE-ONLY)" t nil) (autoload 'org-jekyll-md-export-to-md "ox-jekyll-md" "Export current buffer to a Markdown file adding some YAML front matter.

(fn &optional ASYNC SUBTREEP VISIBLE-ONLY)" t nil) (autoload 'org-jekyll-md-publish-to-md "ox-jekyll-md" "Publish an org file to Markdown with YAML front matter.
...
(fn PLIST FILENAME PUB-DIR)" nil nil) (autoload 'org-jekyll-md-insert-export-options-template "ox-jekyll-md" "Insert a settings template for Jekyll exporter.

(fn &optional TITLE DATE SETUPFILE CATEGORIES TAGS LAYOUT)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ox-jekyll-md" '("org-jekyll-md-"))) (provide 'ox-jekyll-md-autoloads)) "org-bullets" ((org-bullets-autoloads org-bullets) (autoload 'org-bullets-mode "org-bullets" "Use UTF8 bullets in Org mode headings.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "org-bullets" '("org-bullets-"))) (provide 'org-bullets-autoloads)) "all-the-icons" ((all-the-icons-faces all-the-icons all-the-icons-autoloads) (autoload 'all-the-icons-icon-for-dir "all-the-icons" "Get the formatted icon for DIR.
...
(fn &optional ARG FAMILY)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "all-the-icons" '("all-the-icons-"))) (provide 'all-the-icons-autoloads)) "octicons" ((octicons octicons-data octicons-autoloads) (autoload 'octicons "octicons" "Return octicons code point

(fn FONT-NAME)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "octicons" '("octicons--"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "octicons-data" '("octicons-alist"))) (provide 'octicons-autoloads)) "page-break-lines" ((page-break-lines page-break-lines-autoloads) (autoload 'page-break-lines-mode "page-break-lines" "Toggle Page Break Lines mode.
...
(fn &optional ARG)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "page-break-lines" '("page-break-lines-"))) (provide 'page-break-lines-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 11 "melpa" nil "gnu-elpa-mirror" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "use-package" nil "bind-key" nil "auto-package-update" nil "dash" nil "which-key" nil "yasnippet" nil "cl-lib" nil "ace-window" nil "avy" nil "dashboard" nil "doom-themes" nil "rainbow-delimiters" nil "rainbow-mode" nil "bespoke-modeline" nil "ivy" nil "ivy-rich" nil "counsel" nil "swiper" nil "ox-jekyll-md" nil "org-bullets" nil "all-the-icons" nil "octicons" nil "page-break-lines" nil "fontset" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package") "auto-package-update" (auto-package-update :type git :flavor melpa :host github :repo "rranelli/auto-package-update.el") "dash" (dash :type git :flavor melpa :files ("dash.el" "dash.texi" "dash-pkg.el") :host github :repo "magnars/dash.el") "which-key" (which-key :type git :flavor melpa :host github :repo "justbur/emacs-which-key") "yasnippet" (yasnippet :type git :flavor melpa :files ("yasnippet.el" "snippets" "yasnippet-pkg.el") :host github :repo "joaotavora/yasnippet") "cl-lib" nil "ace-window" (ace-window :type git :flavor melpa :host github :repo "abo-abo/ace-window") "avy" (avy :type git :flavor melpa :host github :repo "abo-abo/avy") "dashboard" (dashboard :type git :flavor melpa :files (:defaults "banners" "dashboard-pkg.el") :host github :repo "emacs-dashboard/emacs-dashboard") "doom-themes" (doom-themes :type git :flavor melpa :files (:defaults "themes/*.el" "themes/*/*.el" "extensions/*.el" "doom-themes-pkg.el") :host github :repo "doomemacs/themes") "rainbow-delimiters" (rainbow-delimiters :type git :flavor melpa :host github :repo "Fanael/rainbow-delimiters") "rainbow-mode" nil "bespoke-modeline" nil "ivy" (ivy :type git :flavor melpa :files (:defaults (:exclude "swiper.el" "counsel.el" "ivy-hydra.el" "ivy-avy.el") "doc/ivy-help.org" "ivy-pkg.el") :host github :repo "abo-abo/swiper") "ivy-rich" (ivy-rich :type git :flavor melpa :files ("*.el" "ivy-rich-pkg.el") :host github :repo "Yevgnen/ivy-rich") "counsel" (counsel :type git :flavor melpa :files ("counsel.el" "counsel-pkg.el") :host github :repo "abo-abo/swiper") "swiper" (swiper :type git :flavor melpa :files ("swiper.el" "swiper-pkg.el") :host github :repo "abo-abo/swiper") "ox-jekyll-md" (ox-jekyll-md :type git :flavor melpa :host github :repo "gonsie/ox-jekyll-md") "org-bullets" (org-bullets :type git :flavor melpa :host github :repo "integral-dw/org-bullets") "all-the-icons" (all-the-icons :type git :flavor melpa :files (:defaults "data" "all-the-icons-pkg.el") :host github :repo "domtronn/all-the-icons.el") "octicons" (octicons :type git :flavor melpa :host github :repo "emacsorphanage/octicons") "page-break-lines" (page-break-lines :type git :flavor melpa :host github :repo "purcell/page-break-lines") "fontset" nil)) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "rainbow-mode" (rainbow-mode :type git :host github :repo "emacs-straight/rainbow-mode" :files ("*" (:exclude ".git"))) "bespoke-modeline" nil "fontset" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 1 "emacsmirror-mirror" nil "straight" nil "cl-lib" nil "bespoke-modeline" nil "fontset" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "cl-lib" nil "bespoke-modeline" nil "fontset" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "auto-package-update" "dash" "which-key" "yasnippet" "cl-lib" "ace-window" "avy" "dashboard" "all-the-icons" "page-break-lines" "doom-themes" "rainbow-delimiters" "rainbow-mode" "bespoke-modeline" "fontset" "ivy" "ivy-rich" "counsel" "swiper" "org-bullets" "ox-jekyll-md")
